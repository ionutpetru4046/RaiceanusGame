...
import { Search, Play, Calendar, Eye, ThumbsUp } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="initial" animate="animate" variants={stagger} className="text-center">
            ...
            <motion.p variants={fadeInUp} className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Watch expert poker analysis, strategy tutorials, and tournament highlights. Our video library
              covers everything from beginner basics to advanced techniques.
            </motion.p>
          </motion.div>
        </div>
      </section>
              ...
              <motion.div key={video.id} variants={fadeInUp}>
                <Card className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer group">
                  <div className="aspect-video bg-muted relative overflow-hidden">
                    ...
                    {video.featured && <Badge className="absolute top-2 left-2 bg-primary">Featured</Badge>}
                  </div>
                  <CardHeader>
                    <div className="flex items-center gap-2 mb-2">
