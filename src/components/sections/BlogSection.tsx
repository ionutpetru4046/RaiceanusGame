...
const blogPosts = [
  {
    ...
    excerpt:
      "Learn the fundamental strategies that will give you an edge in Texas Hold'em tournaments and cash games.",
  ...
  },
  {
    ...
    excerpt:
      "Proper bankroll management is crucial for long-term success in poker. Learn the key principles.",
  ...
  },
  {
    ...
    excerpt:
      "Understanding your opponents' behavior and psychology can dramatically improve your win rate.",
  ...
  },
  {
    ...
    excerpt:
      "Tournament poker requires different strategies at different stages. Learn when to be aggressive and when to be conservative.",
  ...
  },
  {
    ...
    excerpt:
      "Understanding expected value (EV) is crucial for making mathematically correct decisions at the table.",
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-24 lg:py-32 bg-background">
        <div className="absolute inset-0 z-0 pointer-events-none" style={{ width: "100%", height: "100%" }}>
          ...
          />
          <div
            className="html5vid rs_html5vidbasicstyles fullcoveredvideo"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="initial" animate="animate" variants={stagger} className="text-center">
            ...
            <motion.p variants={fadeInUp} className="text-xl text-white/80 max-w-3xl mx-auto">
              Expert analysis, strategy guides, and poker education from professional players and coaches.
              Level up your game with our comprehensive blog.
            </motion.p>
          </motion.div>
        </div>
      </section>
