...
const faqs = [
  {
    ...
    answer:
      "Sign up for an account, verify your identity, and join any of our daily tournaments. We offer tournaments for all skill levels and bankrolls.",
  },
  {
    question: "What payment methods do you accept?",
    answer:
      "We accept major credit cards, PayPal, cryptocurrency, and bank transfers. All transactions are secured with 256-bit SSL encryption.",
  },
  {
    question: "Is my personal information safe?",
    answer:
      "Yes, we use industry-leading security measures to protect your data. We comply with GDPR and never share your information with third parties.",
  },
  {
    question: "How do I withdraw my winnings?",
    answer:
      "Withdrawals are processed within 24-48 hours. You can withdraw via the same method you used to deposit, or choose alternative options.",
  },
  {
    question: "Do you offer customer support 24/7?",
    answer:
      "Yes! Our customer support team is available 24/7 through email, phone, and live chat to assist you with any questions or concerns.",
  },
  {
    question: "Can I play on mobile devices?",
    answer:
      "Absolutely! Our platform is fully responsive and works perfectly on all mobile devices, tablets, and desktop computers.",
  },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-24 lg:py-32">
        <div
          ...
          style={{ backgroundImage: "url('/raiceanus-image.webp')" }}
          aria-hidden="true"
        />
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="initial" animate="animate" variants={stagger} className="text-center">
            ...
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-bold tracking-tight mb-6 text-white">
              Contact <span className="text-primary">Us</span>
            </motion.h1>

            <motion.p variants={fadeInUp} className="text-xl text-white/80 max-w-3xl mx-auto">
              Have questions about poker, need help with your account, or want to share feedback? We&apos;re
              here to help you 24/7 with our comprehensive support system.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative py-16 bg-primary text-primary-foreground overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center z-0" style={{ backgroundImage: "url('/vegas-casino.jpg')" }} aria-hidden="true" />
