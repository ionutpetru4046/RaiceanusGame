...
const milestones = [
  {
    ...
    description:
      "The earliest known reference to poker appears in a letter from a French nobleman.",
  },
  {
    year: "1830s",
    title: "Modern Poker Emerges",
    description:
      "Poker as we know it today develops in New Orleans, combining elements from various card games.",
  },
  {
    year: "1970",
    title: "World Series of Poker",
    description:
      "The first World Series of Poker is held in Las Vegas, revolutionizing the game.",
  },
  {
    year: "2003",
    title: "Online Poker Boom",
    description:
      "Online poker platforms become mainstream, making the game accessible worldwide.",
  },
  {
    year: "2024",
    title: "Raiceanus is Born",
    description:
      "A new era of poker begins with our comprehensive platform for players of all levels.",
  },
];
...
const values = [
  {
    ...
    description:
      "We love poker and believe in sharing that passion with everyone who wants to learn and play.",
  },
  {
    icon: Users,
    title: "Community First",
    description:
      "Building a supportive community where players can learn, compete, and grow together.",
  },
  {
    icon: Trophy,
    title: "Excellence",
    description:
      "Striving for the highest standards in content, tournaments, and user experience.",
  },
  {
    icon: Clock,
    title: "Continuous Learning",
    description:
      "Poker is a game of constant evolution, and so are we. Always learning, always improving.",
  },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-linear-to-br from-background via-background to-primary/5 py-24 lg:py-32">
        <div
          ...
          style={{
            backgroundImage: "url('/treasure-island-casino.jpg')",
          }}
          aria-hidden="true"
        />
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              To democratize poker education, foster a thriving community, and provide unparalleled
              gaming experiences that cater to players of every skill level.
            </motion.p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInUp}>
              ...
              <p className="text-muted-foreground mb-6">
                ...
                Raiceanus strikes the perfect balance. We combine cutting-edge technology with deep
                poker expertise to create an environment where everyone can thrive.
              </p>
      ...
      <section className="py-24 bg-primary text-primary-foreground">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center"
          >
            <motion.h2 variants={fadeInUp} className="text-3xl md:text-5xl font-bold mb-16">
