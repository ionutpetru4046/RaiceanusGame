...
const pokerVariants = [
  {
    name: "Texas Hold'em",
    description:
      "The most popular poker variant worldwide, featuring community cards and strategic betting.",
    players: "2-10",
    difficulty: "Medium",
    popularity: "★★★★★",
    rules: [
  ...
  },
  {
    ...
    description:
      "Omaha with pot limit betting structure, creating more aggressive play.",
    players: "2-10",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From Texas Hold&apos;em to exotic variants, learn the rules, strategies, and nuances of every
              poker game. Choose your weapon and dominate the tables.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Tabs defaultValue="variants" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-12">
              <TabsTrigger value="variants" className="text-sm sm:text-lg px-2 sm:px-4">
                Game Variants
              </TabsTrigger>
              <TabsTrigger value="rules" className="text-sm sm:text-lg px-2 sm:px-4">
                Hand Rankings
              </TabsTrigger>
              <TabsTrigger value="strategy" className="text-sm sm:text-lg px-2 sm:px-4">
                Basic Strategy
              </TabsTrigger>
            </TabsList>
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <div className="flex gap-4 flex-wrap">
                          ...
                          <Badge variant="secondary">{selectedVariant.popularity} Popularity</Badge>
                        </div>
                      </CardHeader>
                      <CardContent>
              ...
              <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={stagger}>
                <div className="text-center mb-12">
                  ...
                  <p className="text-muted-foreground max-w-2xl mx-auto">
                    Understanding hand rankings is fundamental to poker. From the mighty Royal Flush to the
                    humble High Card, here&apos;s how hands are ranked from strongest to weakest.
                  </p>
                </div>
                        ...
                        <CardContent className="p-6">
                          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                            <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-6 min-w-0">
                              ...
                              <p className="text-muted-foreground hidden md:block">{hand.description}</p>
                            </div>
                          ...
                          <p className="text-muted-foreground mt-2 md:hidden">{hand.description}</p>
                        </CardContent>
                      </Card>
                    </motion.div>
                  ))}
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        Never risk more than you can afford to lose. Proper bankroll management ensures you
                        can weather the variance and continue playing.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        Pay attention to betting patterns, timing, and physical tells. Understanding what your
                        opponents are likely to do is crucial for success.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        Discipline is essential. Wait for good opportunities rather than playing every hand.
                        The best players know when to fold and when to bet aggressively.
                      </p>
                    </CardContent>
                  </Card>
                </div>
